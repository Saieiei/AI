...
custom_image_path = '/workspaces/codespaces-jupyter/car_test.png'  # Replace with the path to your image
...
# Load your custom image
custom_image_path = '/workspaces/codespaces-jupyter/cow_pic.jpg'  # Replace with the path to your image
custom_image = Image.open(custom_image_path)
